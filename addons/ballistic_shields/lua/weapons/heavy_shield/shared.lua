...
SWEP.PrintName = "Щит OTA - Штурм"
SWEP.Author	= "D3G"
SWEP.Instructions = "ЛКМ - Выбить дверь"
SWEP.Spawnable = true
SWEP.AdminOnly = true
...
SWEP.Category = "Half-Life Alyx Щиты"
...
function SWEP:PrimaryAttack()
	...
	else--if (ent:GetClass() == 'prop_physics' or ent:GetClass() == 'prop_physics_multiplayer') then
