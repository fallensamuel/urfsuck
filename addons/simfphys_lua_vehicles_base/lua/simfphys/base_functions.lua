...
-- Exploit workaround --
if SERVER then
	simfphys.exploited = function(_, ply, netname)
		hook.Run('SimfphysExploitUsed', ply, netname)
		game.KickID(ply:SteamID(), 'Подозрение в использовании эксплоита. Обратитесь к менеджеру.')
	end
end
------------------------
