...
SWEP.ViewModelFOV = 64.321608040201
SWEP.ViewModelFlip = false
SWEP.UseHands = true
SWEP.ViewModel = "models/jessev92/bfv/weapons/blowtorch_c.mdl"
SWEP.WorldModel = "models/jessev92/bfv/weapons/blowtorch_w.mdl"
...
if (CLIENT) then
	SWEP.PrintName			= "Улучшенная паяльная лампа"
