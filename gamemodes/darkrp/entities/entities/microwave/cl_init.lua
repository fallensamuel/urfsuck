-- "gamemodes\\darkrp\\entities\\entities\\microwave\\cl_init.lua"
...
function ENT:Draw()
	...
	draw.SimpleTextOutlined('Консервы', '3d2d', 0, -450, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_TOP, 1, color_black)
	draw.SimpleTextOutlined('Цена: ' .. rp.FormatMoney(self:Getprice()), '3d2d', 0, -450, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_BOTTOM, 1, color_black)
	cam.End3D2D()
