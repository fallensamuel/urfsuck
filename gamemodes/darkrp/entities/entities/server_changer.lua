-- "gamemodes\\darkrp\\entities\\entities\\server_changer.lua"
...
if SERVER then
	...
	function ENT:Initialize()
		self:SetModel('models/stalkertnb2/npc/npc_banditblack.mdl')
	...
	function ENT:Draw()
		...
		draw.SimpleTextOutlined('Отправиться в '..info.name, '3d2d', 0, -450, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_BOTTOM, 1, color_black)
		cam.End3D2D()
	...
	net.Receive('ServerChange', function(len, ply)
		local title = 'Отправиться в '..info.name
