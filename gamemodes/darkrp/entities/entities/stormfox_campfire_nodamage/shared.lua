-- "gamemodes\\darkrp\\entities\\entities\\stormfox_campfire_nodamage\\shared.lua"
-- Retrieved by https://github.com/lewisclark/glua-steal
ENT.Type            = "anim"
ENT.Base            = "base_anim"

ENT.PrintName       = "Campfire No Damage"
ENT.Author          = "Nak & Wish Master"
ENT.Purpose         = "A Campfire"
ENT.Instructions    = "Поставь куда-то безопасный костер"
...
properties.Add( "sf_campfire_ignite", {
    ...
    Filter = function( self, ent, ply )
        ...
        if ent:GetClass() ~= "stormfox_campfire_nodamage" then return false end
