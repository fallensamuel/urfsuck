-- "gamemodes\\darkrp\\entities\\weapons\\armor_kit_admin.lua"
...
SWEP.Primary.Sound = Sound('weapons/sg550/cloth.wav')

function SWEP:Initialize()
	self:SetHoldType(self.HoldType)
	self._Reload.Sound = {Sound('weapons/sg550/cloth.wav', Sound('weapons/g36/boltrecive.wav'))}
end
/*
...
function SWEP:SecondaryAttack() 
	...
	if CLIENT or armor >= 600 then return end
	self.Owner:SetArmor(armor + 25)
