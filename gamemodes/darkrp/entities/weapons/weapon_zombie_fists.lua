-- "gamemodes\\darkrp\\entities\\weapons\\weapon_zombie_fists.lua"
...
function SWEP:DealDamage()
	...
	if ( SERVER && IsValid( tr.Entity ) && ( tr.Entity:IsNPC() || tr.Entity:IsPlayer() || tr.Entity:Health() > 0 ) ) then
		...
		dmginfo:SetDamage( math.random( self.punchMin or 8, self.punchMax or 12 ) )
		...
		elseif ( anim == "fists_uppercut" ) then
			...
			dmginfo:SetDamage( math.random( self.critMin or 12, self.critMax or 24 ) )
		end
...
function SWEP:Deploy()
	...
	self.punchMin = t.punchMin
	self.punchMax = t.punchMax
	self.critMin = t.critMin
	self.critMax = t.critMax
