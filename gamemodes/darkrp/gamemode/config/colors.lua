-- "gamemodes\\darkrp\\gamemode\\config\\colors.lua"
...
--[[
rp.cfg.UIColor.BlockHeader = c(0, 0, 255)
rp.cfg.UIColor.SubHeader = c(0, 255, 0)
rp.cfg.UIColor.Selected = c(255, 0, 0)
]]--
...
if CLIENT then
	ui.col = {
		SUP 			= c(255,248,61,255),
		Background 		= c(10,10,10,170),
		Outline 		= c(100,100,100,255),
		Hover 			= c(255,248,61,255),
		
		Button 			= c(140,140,140),
		ButtonHover 	= c(230,228,61,255),
		ButtonRed 		= c(240,0,0),
