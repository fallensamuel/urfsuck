-- "gamemodes\\darkrp\\gamemode\\config\\emoteactions\\__sitaction.lua"
...
function ACTION:onCall( ply )
	...
	if simfphys and (veh:GetParent() ~= NULL) then
		if simfphys.IsCar( veh:GetParent() ) then return false end
	end
