-- "gamemodes\\darkrp\\gamemode\\config\\emoteactions\\act_power\\action_burpee.lua"
-- Retrieved by https://github.com/lewisclark/glua-steal
local ACTION = table.Copy( EmoteActions:GetRawAction( "__base" ) );

ACTION.Name = "Отжимания + Прыжок";
ACTION.Desc = "";
...
if SERVER then
	function ACTION:onStart( ply )
		...
		recursive = function()
			if IsValid(ply) and ply:GetEmoteAction() == 'burpee' then
...
EmoteActions:RegisterAction( "burpee", ACTION );