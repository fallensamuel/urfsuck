-- "gamemodes\\darkrp\\gamemode\\config\\emoteactions\\act_power\\action_jumpingjack.lua"
...
if SERVER then
	function ACTION:onStart( ply )
		...
		recursive = function()
			if IsValid(ply) and ply:GetEmoteAction() == 'jumpingjack' then
...
EmoteActions:RegisterAction( "jumpingjack", ACTION );