-- "gamemodes\\darkrp\\gamemode\\config\\emoteactions\\act_premium\\action_balletspin.lua"
...
if SERVER then
	function ACTION:onStart( ply )
		...
		recursive = function()
			if IsValid(ply) and ply:GetEmoteAction() == 'balletspin' then
...
EmoteActions:RegisterAction( "balletspin", ACTION );