-- "gamemodes\\darkrp\\gamemode\\config\\emoteactions\\act_premium\\action_dj_drop.lua"
...
if SERVER then
	function ACTION:onStart( ply )
		...
		recursive = function()
			if IsValid(ply) and ply:GetEmoteAction() == 'dj_drop' then
...
EmoteActions:RegisterAction( "dj_drop", ACTION );