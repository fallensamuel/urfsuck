-- "gamemodes\\darkrp\\gamemode\\config\\emoteactions\\act_premium\\action_gothdance.lua"
...
if SERVER then
	function ACTION:onStart( ply )
		...
		recursive = function()
			if IsValid(ply) and ply:GetEmoteAction() == 'gothdance' then
...
EmoteActions:RegisterAction( "gothdance", ACTION );