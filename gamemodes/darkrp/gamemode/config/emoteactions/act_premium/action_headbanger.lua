-- "gamemodes\\darkrp\\gamemode\\config\\emoteactions\\act_premium\\action_headbanger.lua"
-- Retrieved by https://github.com/lewisclark/glua-steal
local ACTION = table.Copy( EmoteActions:GetRawAction( "__base" ) );

ACTION.Name = "Панк Рок";
ACTION.Desc = "";
...
if SERVER then
	function ACTION:onStart( ply )
		...
		recursive = function()
			if IsValid(ply) and ply:GetEmoteAction() == 'headbanger' then
...
EmoteActions:RegisterAction( "headbanger", ACTION );