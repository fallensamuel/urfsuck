-- "gamemodes\\darkrp\\gamemode\\config\\emoteactions\\act_premium\\action_irishjig.lua"
-- Retrieved by https://github.com/lewisclark/glua-steal
local ACTION = table.Copy( EmoteActions:GetRawAction( "__base" ) );

ACTION.Name = "Ирландский Танец";
ACTION.Desc = "";
...
if SERVER then
	function ACTION:onStart( ply )
		...
		recursive = function()
			if IsValid(ply) and ply:GetEmoteAction() == 'irishjig' then
...
EmoteActions:RegisterAction( "irishjig", ACTION );