-- "gamemodes\\darkrp\\gamemode\\config\\emoteactions\\act_premium\\action_jaywalk.lua"
-- Retrieved by https://github.com/lewisclark/glua-steal
local ACTION = table.Copy( EmoteActions:GetRawAction( "__base" ) );

ACTION.Name = "Прогулка";
ACTION.Desc = "";
...
if SERVER then
	function ACTION:onStart( ply )
		...
		recursive = function()
			if IsValid(ply) and ply:GetEmoteAction() == 'jaywalk' then
...
EmoteActions:RegisterAction( "jaywalk", ACTION );