-- "gamemodes\\darkrp\\gamemode\\config\\emoteactions\\act_premium\\action_mello.lua"
-- Retrieved by https://github.com/lewisclark/glua-steal
local ACTION = table.Copy( EmoteActions:GetRawAction( "__base" ) );

ACTION.Name = "Танец Маршмеллоу";
ACTION.Desc = "";
...
if SERVER then
	function ACTION:onStart( ply )
		...
		recursive = function()
			if IsValid(ply) and ply:GetEmoteAction() == 'mello' then
...
EmoteActions:RegisterAction( "mello", ACTION );