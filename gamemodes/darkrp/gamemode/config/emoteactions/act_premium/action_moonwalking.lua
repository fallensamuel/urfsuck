-- "gamemodes\\darkrp\\gamemode\\config\\emoteactions\\act_premium\\action_moonwalking.lua"
-- Retrieved by https://github.com/lewisclark/glua-steal
local ACTION = table.Copy( EmoteActions:GetRawAction( "__base" ) );

ACTION.Name = "Прогулка по луне";
ACTION.Desc = "";
...
if SERVER then
	function ACTION:onStart( ply )
		...
		recursive = function()
			if IsValid(ply) and ply:GetEmoteAction() == 'f_moonwalking' then
...
EmoteActions:RegisterAction( "moonwalking", ACTION );