-- "gamemodes\\darkrp\\gamemode\\config\\emoteactions\\act_premium\\action_robotdance.lua"
-- Retrieved by https://github.com/lewisclark/glua-steal
local ACTION = table.Copy( EmoteActions:GetRawAction( "__base" ) );

ACTION.Name = "Танец Робота";
ACTION.Desc = "";
...
if SERVER then
	function ACTION:onStart( ply )
		...
		recursive = function()
			if IsValid(ply) and ply:GetEmoteAction() == 'robotdance' then
...
EmoteActions:RegisterAction( "robotdance", ACTION );