-- "gamemodes\\darkrp\\gamemode\\config\\emoteactions\\act_premium\\action_skeletondance.lua"
-- Retrieved by https://github.com/lewisclark/glua-steal
local ACTION = table.Copy( EmoteActions:GetRawAction( "__base" ) );

ACTION.Name = "Танец Скелета";
ACTION.Desc = "";
...
if SERVER then
	function ACTION:onStart( ply )
		...
		recursive = function()
			if IsValid(ply) and ply:GetEmoteAction() == 'skeletondance' then
...
EmoteActions:RegisterAction( "skeletondance", ACTION );