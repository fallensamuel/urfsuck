-- "gamemodes\\darkrp\\gamemode\\config\\emoteactions\\act_premium\\action_smooth_ride.lua"
-- Retrieved by https://github.com/lewisclark/glua-steal
local ACTION = table.Copy( EmoteActions:GetRawAction( "__base" ) );

ACTION.Name = "Танец Снупа";
ACTION.Desc = "";
...
if SERVER then
	function ACTION:onStart( ply )
		...
		recursive = function()
			if IsValid(ply) and ply:GetEmoteAction() == 'smooth_ride' then
...
EmoteActions:RegisterAction( "smooth_ride", ACTION );