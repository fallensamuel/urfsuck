-- "gamemodes\\darkrp\\gamemode\\config\\emoteactions\\act_premium\\action_technozombie.lua"
-- Retrieved by https://github.com/lewisclark/glua-steal
local ACTION = table.Copy( EmoteActions:GetRawAction( "__base" ) );

ACTION.Name = "Танец Технозомби";
ACTION.Desc = "";
...
if SERVER then
	function ACTION:onStart( ply )
		...
		recursive = function()
			if IsValid(ply) and ply:GetEmoteAction() == 'f_technozombie' then
...
EmoteActions:RegisterAction( "f_technozombie", ACTION );