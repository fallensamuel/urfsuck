-- "gamemodes\\darkrp\\gamemode\\config\\emoteactions\\act_premium\\action_worm.lua"
...
if SERVER then
	function ACTION:onStart( ply )
		...
		recursive = function()
			if IsValid(ply) and ply:GetEmoteAction() == 'dance_worm' then
...
EmoteActions:RegisterAction( "dance_worm", ACTION );