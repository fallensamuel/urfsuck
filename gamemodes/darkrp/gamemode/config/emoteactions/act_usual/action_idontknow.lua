-- "gamemodes\\darkrp\\gamemode\\config\\emoteactions\\act_usual\\action_idontknow.lua"
-- Retrieved by https://github.com/lewisclark/glua-steal
local ACTION = table.Copy( EmoteActions:GetRawAction( "__base" ) );

ACTION.Name = "Я не знаю";
ACTION.Desc = "";
...
if SERVER then
	function ACTION:onStart( ply )
		...
		recursive = function()
			if IsValid(ply) and ply:GetEmoteAction() == 'idontknow' then
...
EmoteActions:RegisterAction( "idontknow", ACTION );