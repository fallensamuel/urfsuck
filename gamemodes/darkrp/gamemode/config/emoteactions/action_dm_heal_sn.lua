-- "gamemodes\\darkrp\\gamemode\\config\\emoteactions\\action_dm_heal_sn.lua"
...
if SERVER then
	function ACTION:onStart( ply )
		...
		ply:SetEmoteActionSequences( "stand_eat_0", 0, function()
...
EmoteActions:RegisterAction( "dm_heal_sn", ACTION );