-- "gamemodes\\darkrp\\gamemode\\config\\items\\sh_present_4.lua"
-- Retrieved by https://github.com/lewisclark/glua-steal
ITEM.name = "Подарок: Случайное Оружие"
ITEM.icon_override = "rpui/icons/ny_gun_gift"
ITEM.width = 1
ITEM.height = 1
