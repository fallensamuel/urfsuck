-- "gamemodes\\darkrp\\gamemode\\config\\npcs\\provodnik\\cl_init.lua"
-- Retrieved by https://github.com/lewisclark/glua-steal
NPC.name = "Проводник ЧН"
...
function NPC:onStart(isGoTo)
    ...
    self:addText("*Перед вами проводник ЧН*")
    self:addText("Здравствуй, уже 3-ий год зону топчу, могу провести в любую точку. За плату естественно")
    	...
    	self:addOption("Я бы хотел пройтись по зоне, есть места куда можешь провести?", function()
			...
			self:addOption("Проведи к...", function()
    			rp.OpenTeleportMenu({SPAWN_CH, SPAWN_MONOL, SPAWN_BAND, SPAWN_DOLG, SPAWN_RENEG, SPAWN_SVOBOD, SPAWN_GAVAEC, SPAWN_FERMA, SPAWN_JEWUSI})
				self:close()
			end)
		end)
