...
util.AddNetworkString('CookingsetFoodNet1');
local NetCooldown = 1;

function ENT:Initialize()
    self.Model = 'models/props_rp/stove2.mdl';
...
net.Receive('CookingsetFoodNet1', function(Length, Player)
    ...
    for Index, Entity in pairs(ents.FindByClass('cookingset_stove')) do 
