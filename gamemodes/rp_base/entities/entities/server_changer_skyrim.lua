...
if SERVER then
	...
	function ENT:Initialize()
		self:SetModel('models/player/guard_dawnstar_npc.mdl')
	...
	function ENT:Draw()
		...
		draw.SimpleTextOutlined(cached[2] .. ' '..info.name4, '3d2d', 0, -450, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_BOTTOM, 1, color_black)
		cam.End3D2D()
	...
	net.Receive('ServerChange4', function(len, ply)
		local title = cached[2] .. ' '..info.name4
