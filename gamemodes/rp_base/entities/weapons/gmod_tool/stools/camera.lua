-- "gamemodes\\rp_base\\entities\\weapons\\gmod_tool\\stools\\camera.lua"
...
local function MakeCamera( ply, key, locked, toggle, Data )
	...
	if ( IsValid( ply ) && !ply:CheckLimit( "cameras" ) ) then return false end
...
function TOOL:LeftClick( trace )
	...
	if ( !self:GetSWEP():CheckLimit( "cameras" ) ) then return false end
