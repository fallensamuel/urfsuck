-- "gamemodes\\rp_base\\entities\\weapons\\gmod_tool\\stools\\lamp.lua"
...
TOOL.ClientConVar[ "distance" ] = "512"
...
function TOOL:LeftClick( trace )
	...
	local mdl = "models/lamps/torch.mdl"--list.Get('LampModels')[self:GetClientInfo( "model" )] or "models/lamps/torch.mdl"
	local fov = math.Clamp(self:GetClientNumber("fov"), 0, 90)
	local distance = math.Clamp(self:GetClientNumber("distance"), 0, 500)
...
if ( SERVER ) then
	...
	function MakeLamp( pl, r, g, b, KeyDown, toggle, Texture, Model, fov, distance, brightness, on, Data )
		...
		lamp:SetModel( 'models/lamps/torch.mdl' )--istable(Model) and table.Random(Model) or 'models/lamps/torch.mdl' )
...
function TOOL.BuildCPanel( CPanel )
	...
	CPanel:AddControl( "Slider", { Label = "#tool.lamp.fov", Command = "lamp_fov", Type = "Float", Min = 10, Max = 90 } )
	CPanel:AddControl( "Slider", { Label = "#tool.lamp.distance", Command = "lamp_distance", Min = 64, Max = 500 } )
