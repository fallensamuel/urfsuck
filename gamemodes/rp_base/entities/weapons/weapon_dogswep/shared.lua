...
SWEP.AdminOnly = true -- If you and others can see this in weapon spawn menu (Q---> Weapons)
...
SWEP.Author = ""
SWEP.Purpose = ""
SWEP.Instructions = "ЛКМ - кусать / ПКМ - лаять."
...
function SWEP:PrimaryAttack()
	...
	timer.Simple(1.4, function(wep) if IsValid(self) then self:SendWeaponAnim(ACT_VM_IDLE) end end)
