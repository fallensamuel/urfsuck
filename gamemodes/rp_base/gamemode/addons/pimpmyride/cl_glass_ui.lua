...
function PANEL:Init()
	...
	self.m_cBackground = Color(123, 123, 123)
	self.m_cBackgroundHover = Color(255, 255, 255)
...
function PANEL:Paint(w, h)
	if self:IsHovered() then
		surface.SetDrawColor(255, 255, 255, 100)
		surface.DrawRect(0, 0, w, h)
		surface.SetDrawColor(self.m_cBackgroundHover)
		surface.DrawOutlinedRect(0, 0, w, h)
	else
...
hook.Add("PostDrawHUD", "Compizz", function()
	...
	__drawchildren(w)
	render.BlurRenderTarget(rt, 5, 5, 1)
