...
timer.Simple(4, function() for k,v in pairs(ents.FindByClass("info_overlay")) do v:Remove() end end)
...
util.AddNetworkString('rp.Stat.ServerConnections')

net.Receive('rp.Stat.ServerConnections', function()
	print('ConnectTo', net.ReadString() or 'nil')
end)
