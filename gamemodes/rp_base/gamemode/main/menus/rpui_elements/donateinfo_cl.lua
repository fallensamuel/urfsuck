...
function PANEL:Paint(w, h)
    if self.DisabledNow then return end
    ...
    rpui.ExperimentalStencil(function()
        ...
        if show3lines then
            ...
            draw.SimpleText(txt, font1, w * 0.5, h * 0.675, black, TEXT_ALIGN_CENTER, TEXT_ALIGN_BOTTOM)
            draw.SimpleText(line2txt or Out, font2, w * 0.5, h * 0.625, black, TEXT_ALIGN_CENTER, TEXT_ALIGN_TOP)
        end
