...
function rp.pp.PlayerCanManipulate(pl, ent)
	...
	return (ent:CPPIGetOwner() == pl) or (pl:HasAccess('a') and ba.canAdmin(pl) and IsValid(ent:CPPIGetOwner())) or (hook.Run("rp.pp.PlayerCanManipulate", pl, ent) == true)
end
...
ENTITY.SafeSetPos = ENTITY._SetPos or ENTITY.SetPos
