...
SWEP.Sounds = 
{ 
	Attack1		= Sound('NPC_AntlionGuard.Shove'), 
	Attack2		= Sound('NPC_AntlionGuard.Anger'), 
	Step		= Sound('NPC_AntlionGuard.StepHeavy'), 
	Hit		 	= Sound('NPC_AntlionGuard.HitHard'), 
	Angry		= Sound('NPC_AntlionGuard.Pain_Roar'), 
	Idle		= Sound('NPC_AntlionGuard.GrowlIdle')
}
