...
rp.AddTerm('CannotLockdown', 'Изменение положения в городе сейчас недоступно.')
rp.AddTerm('LockdownStarted', 'Объявлен #!')
rp.AddTerm('CannotUnlockdown', 'Вы не можете отменить положение в городе сейчас.')
rp.AddTerm('LockdownEnded', '# окончен/окончена/окончено.')
...
rp.AddTerm('YouHired', 'вы няняли # для #.')
...
rp.AddTerm('IncorrectJob', 'У вас недостаточно полномочий чтобы сделать это!')
...
rp.AddTerm('TaxWeapon_CantTake', 'У # не хватает денег, чтобы оплатить налог.')
rp.AddTerm('TaxWeapon_CantGive', 'Вам не хватает #, чтобы оплатить налог.')
rp.AddTerm('TaxWeapon_Take', 'Вы собрали налог в размере # с #.')
rp.AddTerm('TaxWeapon_Give', '# собрал с Вас налог в размере #.')
rp.AddTerm('TaxWeapon_CWU', 'Налог можно собирать только с членов ГСР.')
...
rp.AddTerm('AntihumanSpeedBoost', 'С17.ANTI-HUMAN.Creator увеличивает отряду ANTI-HUMAN скорость бега и броню!')
rp.AddTerm('AntihumanSpeedBoost2', 'Мопс увеличивает отряду Сопротивления скорость бега и броню!')
rp.AddTerm('PMC', "Вы должны быть членом организации PMC Black Bear!")
...
rp.AddTerm('puplpbust', 'Инквизитор увеличивает отряду скорость бега и броню!')
rp.AddTerm('ciabust', 'Джаггернаут увеличивает отряду скорость бега и броню!')

rp.AddTerm('Secboost', 'CMD.SeC увеличивает отряду MPF здоровье и броню!')
rp.AddTerm('Ovlboost', 'OTA.KING.Overlord увеличивает дивизиону OTA здоровье и броню!')
rp.AddTerm('Eliboost', 'Илай Вэнс воодушевил вас, увеличив вам здоровье и броню!')
...
rp.AddTerm( "ArmHeist.AllianceStorage.Warning",        "Внимание! Происходит ограбление Оружейного Склада Альянса!" );
rp.AddTerm( "ArmHeist.AllianceStorage.InProgress",     "Ограбление Оружейного Склада Альянса уже в процессе!" );
rp.AddTerm( "ArmHeist.AllianceStorage.Cooldown",       "Ограбление Оружейного Склада Альянса находится в перезарядке." ); 
rp.AddTerm( "ArmHeist.AllianceStorage.NotAnAttacker",  "Вы не можете грабить склад." );
rp.AddTerm( "ArmHeist.AllianceStorage.LowAttackers",   "Слишком мало повстанцев/изгоев для запуска ограбления Оружейного Склада Альянса. (Необходимо ещё #)" );
rp.AddTerm( "ArmHeist.AllianceStorage.LowDefenders",   "Слишком мало юнитов для запуска ограбления Оружейного Склада Альянса. (Необходимо ещё #)" );
rp.AddTerm( "ArmHeist.AllianceStorage.DefendersHelp",  "Вы получили награду в размере # за защиту Оружейного Склада Альянса." );

rp.AddTerm( "ArmHeist.AllianceRacion.Warning",        "Внимание! Происходит ограбление Рационной!" );
rp.AddTerm( "ArmHeist.AllianceRacion.InProgress",     "Ограбление Рационной уже в процессе!" );
rp.AddTerm( "ArmHeist.AllianceRacion.Cooldown",       "Ограбление Рационной находится в перезарядке." ); 
rp.AddTerm( "ArmHeist.AllianceRacion.NotAnAttacker",  "Вы не можете грабить Рационную." );
rp.AddTerm( "ArmHeist.AllianceRacion.LowAttackers",   "Слишком мало повстанцев/изгоев для запуска ограбления Рационной. (Необходимо ещё #)" );
rp.AddTerm( "ArmHeist.AllianceRacion.LowDefenders",   "Слишком мало юнитов для запуска ограбления Рационной. (Необходимо ещё #)" );
rp.AddTerm( "ArmHeist.AllianceRacion.DefendersHelp",  "Вы получили награду в размере # за защиту Рационной." );


rp.AddTerm( "ArmHeist.RebelBase.Warning",        "Внимание! Происходит ограбление склада Повстанцев!" );
rp.AddTerm( "ArmHeist.RebelBase.InProgress",     "Ограбление склада Повстанцев уже в процессе!" );
rp.AddTerm( "ArmHeist.RebelBase.Cooldown",       "Ограбление склада Повстанцев находится в перезарядке." ); 
rp.AddTerm( "ArmHeist.RebelBase.NotAnAttacker",  "Вы не можете грабить склад Повстанцев." );
rp.AddTerm( "ArmHeist.RebelBase.LowAttackers",   "Слишком мало изгоев для запуска ограбления Рационной. (Необходимо ещё #)" );
rp.AddTerm( "ArmHeist.RebelBase.LowDefenders",   "Слишком мало юнитов для запуска ограбления Рационной. (Необходимо ещё #)" );
rp.AddTerm( "ArmHeist.RebelBase.DefendersHelp",  "Вы получили награду в размере # за защиту склада Повстанцев." );

rp.AddTerm( "ArmHeistNotBadGuy",  "Вы не можете ограбить это." );

rp.AddTerm( "NotACurier",  "Вы не курьер!" );
rp.AddTerm( "NotAGunner",  "Вы не оружейник!" );
rp.AddTerm( "AmmoGiven",  "Получена амуниция!" );

rp.AddTerm( "AmmoNotRebel",  "Вы не являетесь повстанцем!" );
rp.AddTerm( "AmmoNotAlliance",  "Вы не состоите в Альянсе!" );

rp.AddTerm( "TestPromoDenied",  "Вы не использовали соответствующий промокод!" );
...
rp.AddTerm( 'OtaMorph.JobSelected', "Профессия чипирования выбрана: #" ); 
rp.AddTerm( 'OtaMorph.CantTakeJob', "Данная модель OTA вам недоступна!" ); 
rp.AddTerm( 'OtaMorph.JobSwitched', "Вас чипировали!" ); 
rp.AddTerm( 'OtaMorph.AlreadyStarted', "Чипирование уже в процессе!" ); 

rp.AddTerm( 'ByeJob', "Вы потеряли должность в связи со смертью!" ); 
